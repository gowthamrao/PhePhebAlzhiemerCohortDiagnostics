...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45533052,45557146,45561994)

) I
) C UNION ALL 
SELECT 1 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4218017,4220313)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4218017,4220313)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9201,9202)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
WHERE PR.specialty_concept_id in (38003663,38004458,38003893,43125860,38003981,38003983,38003985,38003986,38003987,903251,38003994,38003995,38003996,38003997,3193668,4075506,38004058,3194692,4205969,44777725,44777781,3197373,4207073,800946,45756788,45756834,33005)
-- End Visit Occurrence Criteria
...
select event_id, person_id, 
  case when DATEADD(day,1460,start_date) > op_end_date then op_end_date else DATEADD(day,1460,start_date) end as end_date
INTO #strategy_ends
