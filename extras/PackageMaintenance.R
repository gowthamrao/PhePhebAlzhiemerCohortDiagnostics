...
#
# This file is part of PhePhebAlzhiemerCohortDiagnostics
#
...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("PhePhebAlzhiemerCohortDiagnostics")
...
OhdsiRTools::createRenvLockFile(
  rootPackage = "PhePhebAlzhiemerCohortDiagnostics",
  mode = "description",
