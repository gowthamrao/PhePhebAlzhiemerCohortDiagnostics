...
version <- "v0.1.0"
name <- "Phenotype Phebruary 2024 - Alzheimiers disease"
packageName <- "PhePhebAlzhiemerCohortDiagnostics"
...
description <- "Cohort diagnostics on Alzheimer Disease cohorts."
